    ...
    <div className="relative flex items-center justify-center min-h-screen bg-gradient-to-tr from-gray-800 via-gray-700 to-gray-600 text-white overflow-hidden">
      ...
      <div className="relative text-center px-6">
        ...
        <p className="text-lg md:text-xl mb-8 text-gray-200 max-w-xl mx-auto">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt error voluptates voluptatem saepe dignissimos, laborum aliquid corrupti neque nihil libero quod, dolore nam dicta quae quaerat accusantium fugiat facilis quam?
        </p>
